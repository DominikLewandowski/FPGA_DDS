...
set_property -dict { PACKAGE_PIN W15   IOSTANDARD LVCMOS33     } [get_ports { spi_sck }]; #IO_L10N_T1_34 Sch=jc_n[1]		     
set_property -dict { PACKAGE_PIN T11   IOSTANDARD LVCMOS33     } [get_ports { spi_cs }]; #IO_L1P_T0_34 Sch=jc_p[2]              
